...
const Map<String, FocuxSurfaceSpec> focuxSurfaceCatalog = {
  ...
  '/alunos/:id/alimentar': FocuxSurfaceSpec(
    type: _s3,
    logicalParent: '/alunos/:id',
  ),
  ...
  '/exercicios': FocuxSurfaceSpec(type: _s4, logicalParent: '/treinos'),
  ...
  '/perfil/wallet': FocuxSurfaceSpec(type: _s3, logicalParent: _perfil),
  ...
  '/setup/identidade': FocuxSurfaceSpec(type: _s9, logicalParent: _perfil),
  ...
  '/chat/inbox': FocuxSurfaceSpec(type: _s4, logicalParent: _home),
  '/chat/aluno': FocuxSurfaceSpec(type: _s4, logicalParent: _alunoHome),
  ...
  '/ofertas-upsell': FocuxSurfaceSpec(type: _s6, logicalParent: '/assinatura'),
  '/cancel-save': FocuxSurfaceSpec(type: _s6, logicalParent: '/assinatura'),
  ...
  '/loja': FocuxSurfaceSpec(type: _s4, logicalParent: _ferramentas),
  '/perfil/equipe': FocuxSurfaceSpec(type: _s4, logicalParent: _perfil),
  '/pacotes': FocuxSurfaceSpec(type: _s4, logicalParent: '/financeiro'),
  '/leads-publicos': FocuxSurfaceSpec(type: _s4, logicalParent: '/leads'),
  ...
  '/winback': FocuxSurfaceSpec(type: _s4, logicalParent: _home),
  '/relatorio/business': FocuxSurfaceSpec(type: _s1, logicalParent: _home),
  '/recorrencia': FocuxSurfaceSpec(type: _s4, logicalParent: '/financeiro'),
  '/nps': FocuxSurfaceSpec(type: _s1, logicalParent: _home),
  '/grupo-aulas': FocuxSurfaceSpec(type: _s4, logicalParent: _home),
  '/migracao-magica': FocuxSurfaceSpec(type: _s9, logicalParent: _perfil),
  '/migracao-focux': FocuxSurfaceSpec(type: _s9, logicalParent: _perfil),
  '/growth/migracao': FocuxSurfaceSpec(type: _s9, logicalParent: _perfil),
