...
/// Warms Home providers before navigation so the dashboard paints faster.
void prefetchPersonalDashboardHome(WidgetRef ref) {
  unawaited(_ignoreErrors(ref.read(dashboardProvider.future)));
  unawaited(_ignoreErrors(ref.read(commandCenterProvider.future)));
