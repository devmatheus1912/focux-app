  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        ...
        _pedidos = results[1] as List<Map<String, dynamic>>;
    ...
    try {
      final result = await ref
          ...
          .checkout(
            ...
            buyerNome:
                nomeCtrl.text.trim().isEmpty ? null : nomeCtrl.text.trim(),
          );

      if (!mounted) return;

      final pix = result['pixCopiaECola'] as String? ?? '';
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TabBarView(
                        controller: _tabs,
                        children: [
                          _buildVitrine(scheme),
                          _buildPedidos(scheme),
                        ],
                      ),
                    ),
                  ],
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          return FxStaggerItem(
            ...
            child: Semantics(
              label: 'Pacote ${p.titulo}, ${p.valor} reais',
