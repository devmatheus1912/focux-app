          ...
          child: Column(
            children: [
              ...
              if (transactionId != null && transactionId!.isNotEmpty) ...[
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('ID da transação', style: TokensStrip.bodyMuted(color: mute)),
              ...
              Align(
                ...
                child: Text('Próximos passos', style: TokensStrip.h2(color: ink).copyWith(fontSize: 17)),
              ),
                ...
                (step) => Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(child: Text(step, style: TokensStrip.body(color: ink))),
                    ],
                  ),
                ),
              ),
              ...
              FilledButton(
                ...
                child: const Text('Começar agora', style: TextStyle(fontWeight: FontWeight.w900)),
              ),
            ],
          ),
        ),
