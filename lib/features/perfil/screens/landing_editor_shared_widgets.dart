...
class LandingEditorImageUploadCard extends StatelessWidget {
  ...
  String? get _displayUrl =>
      _hasManualImage
          ? imageUrl
          : (_usesDefaultPreview ? defaultPreviewUrl : null);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    emptyHint ??
                        'Sem foto — sua página abre com título e botões.',
                    style: TextStyle(
                      fontSize: 13,
            ...
            children: [
              Expanded(
                child: FilledButton.tonalIcon(
                  ...
                  icon: Icon(
                    uploading ? Icons.hourglass_top : Icons.upload_outlined,
                  ),
...
InputDecoration landingEditorFieldDecoration(
  ...
  return FxInputDeco.build(context, labelText).copyWith(
    ...
    counterStyle: landingEditorMutedStyle(
      context,
