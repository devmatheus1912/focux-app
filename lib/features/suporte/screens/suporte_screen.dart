...
class _SuporteScreenState extends ConsumerState<SuporteScreen>
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: TabBarView(
      controller: _tabController,
      children: const [_AbrirTicketTab(), _MeusTicketsTab()],
    ),
  );
}
          ...
          if (_ticketCriado != null) ...[
            Card(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.check_circle, color: EagleTokens.good),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Ticket #${_ticketCriado!.id} criado',
                            style: const TextStyle(fontWeight: FontWeight.bold),
                          ),
                          Text(
                            _ticketCriado!.titulo,
