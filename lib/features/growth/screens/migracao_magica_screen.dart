...
class _MigracaoMagicaScreenState extends ConsumerState<MigracaoMagicaScreen> {
    ...
    if (_controller.text.isEmpty) {
      if (mounted) {
        FeedbackHelper.showError(
          context,
          'Cole os dados do concorrente primeiro.',
        );
      }
      return;
    }
      ...
      if (mounted) {
        ...
        if (_alunosEncontrados != null && _alunosEncontrados!.isNotEmpty) {
          FeedbackHelper.showSuccess(
            context,
            'Alunos lidos com sucesso pela IA!',
          );
        } else {
          FeedbackHelper.showError(
            context,
            'A IA não encontrou alunos. Revise o texto.',
          );
        }
      }
    } catch (e) {
  ...
  Future<void> _salvarAlunos() async {
    ...
    try {
      ...
      if (mounted) {
        final importados =
            response.data['importados'] ?? _alunosEncontrados!.length;
        FeedbackHelper.showSuccess(
          context,
      ...
      if (mounted) {
        FeedbackHelper.showError(
          context,
          'Erro ao salvar alunos. Tente novamente.',
        );
      }
    } finally {
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient:
                      isDark
                          ? LinearGradient(
                            colors: [brandDeep, const Color(0xFF0A0F1E)],
                          )
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...[
                      'Cole PDF, Excel ou print de outro app',
                      'A IA lê e extrai nome, email, telefone e objetivo',
                      'Confirme e todos os alunos são salvos no Focux',
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color:
                            isDark ? const Color(0xFF2BB673) : EagleTokens.good,
                        width: 1.5,
                      ),
                        ...
                        _isSaving
                            ...
                            : Row(
                              ...
                              children: [
                                ...
                                const SizedBox(width: 8),
                                Text(
                                  'Confirmar e salvar ${_alunosEncontrados!.length} alunos',
                                  style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w700,
                                    color:
