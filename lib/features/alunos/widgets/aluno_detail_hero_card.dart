              ...
              Expanded(
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    // FittedBox absorve excedente de altura no slot fixo do
                    // header. Sem LayoutBuilder interno (quebra intrinsics) —
                    // a largura vem deste builder externo.
                    return FittedBox(
                                ...
                                children: [
                                  Builder(
                                    builder: (context) {
                                      ...
                                      final nameMaxWidth = (constraints
                                                  .maxWidth -
                                              avatarSize -
                                              12)
