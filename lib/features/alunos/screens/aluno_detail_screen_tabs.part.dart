...
class _AlunoDetailTabBar extends StatelessWidget {
  const _AlunoDetailTabBar({
...
class _Aluno360HeaderToolbar extends StatelessWidget {
  const _Aluno360HeaderToolbar({
...
class _Aluno360CompositeHeaderDelegate extends SliverPersistentHeaderDelegate {
  const _Aluno360CompositeHeaderDelegate({
  ...
  @override
  bool shouldRebuild(covariant _Aluno360CompositeHeaderDelegate oldDelegate) {
